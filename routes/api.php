...
// options
Route::get('options/report/video/reasons', '\App\Http\Controllers\OptionController@reportVideoReasonsGet')->name("options.report.video.reasons.show");
Route::get('options/report/comment/reasons', '\App\Http\Controllers\OptionController@reportCommentReasonsGet');
Route::get('options/video/hide/reasons', '\App\Http\Controllers\OptionController@hideVideoReasonsGet');
Route::get('options/video/delete/reasons', '\App\Http\Controllers\OptionController@deleteVideoReasonsGet');
Route::get('options/comment/delete/reasons', '\App\Http\Controllers\OptionController@deleteCommentReasonsGet');
Route::get('options/publisher-request/reject/reasons', '\App\Http\Controllers\OptionController@rejectPublisherRequestReasonsGet');
...
Route::group([
    ...
    Route::post('options/report/video/reasons', '\App\Http\Controllers\OptionController@reportVideoReasonsStore')->name("options.report.video.reasons.store");
    Route::post('options/report/comment/reasons', '\App\Http\Controllers\OptionController@reportCommentReasonsStore')->name("options.report.comment.reasons.store");
    Route::post('options/video/hide/reasons', '\App\Http\Controllers\OptionController@hideVideoReasonsStore')->name("options.video.hide.reasons.store");
    Route::post('options/video/delete/reasons', '\App\Http\Controllers\OptionController@deleteVideoReasonsStore')->name("options.video.delete.reasons.store");
    Route::post('options/comment/delete/reasons', '\App\Http\Controllers\OptionController@deleteCommentReasonsStore')->name("options.comment.delete.reasons.store");
    Route::post('options/publisher-request/reject/reasons', '\App\Http\Controllers\OptionController@rejectPublisherRequestReasonsStore')->name("options.publisher-request.reject.reasons.store");
