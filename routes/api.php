...
Route::get('cryptocurrency', '\App\Http\Controllers\CryptoCurrencyController@index');
Route::get('cryptocurrency/{symbol}', '\App\Http\Controllers\CryptoCurrencyController@GetRatio');
