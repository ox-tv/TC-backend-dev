...
Route::group([
    ...
    Route::post('profile/payment-details', '\App\Http\Controllers\PaymentDetailsController@storeEthAddress')->name('profile.payment-details.store-eth')/*->middleware(['2fa.or.email-verification'])*/;
