...
return [
    ...
    'application_reply_for_youtube_platform_users' => 'As you are active on YouTube already we need some information to verify you. \n Please provide your YouTube channel url. Also you need to share a private YouTube video with the title (Oxin TV) to verify@todayscrypto.com and paste your video link here. \n We will go though your verification process and let you know once it’s done.',

    'messages' => [
        'wait_for_verification' => 'Your request submitted, Oxin TV support will contact you as soon as we can verify your request',
    ]
