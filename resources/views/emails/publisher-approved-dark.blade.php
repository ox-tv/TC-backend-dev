...
<head>
    ...
    <title>Publisher Request Approved</title>
...
For this service, click the "Request Import" button below. You can create a request later via our support center inside the publisher panel if you don't want to do this now.</span></div>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 6px;background-color: #F15858;">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica Neue, Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 12px;">
                                                    <a class="mcnButton " title="Request Import" href="{{ config("general.IMPORT_REQUEST_URL") }}" target="_blank"style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF; text-transform: uppercase;">Request Import</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 7px;background-color: #3F4A6C;">
                                            <tbody>
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 12px;">
                                                    <a class="mcnButton " title="Visit your Publisher Panel" href="{{ config("general.PUBLISHER_PANEL_URL") }}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit your Publisher Panel</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
