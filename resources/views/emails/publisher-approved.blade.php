...
<head>
    ...
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=P4FdSBdcVLR_RNaO628cmOJYrpE5PAvuhQiVJpJxP9PMcXapbv-v5M8mLgx0g-ZDuQE8RhESH22Pdk6vGCuiZ-l18Cgb4YPQRoM94kvkD8-6-NkuQ-tAgp9QgJiFKKZoM_wKvQhyXKXInbgaWZPSrbEhBlGvEBZ1BF5Lb6A7GnypJ-YqanngsiYYfLXQQ-nIo4K-1NmAbE8-Eh_8A03pnoOaYvvOSP2QNvGWhuVjNE4" charset="UTF-8"></script><style type="text/css">
        p{
            margin:10px 0;
            padding:0;
        }
                                            ...
                                            <tbody><tr>
                                                <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                    ...
                                                    <a href="http://www.todayscrypto.com" title="" class="" target="_blank">
                                                        <img align="center" alt="" src="https://mcusercontent.com/f7434511997c37d3840fc9c58/images/bf7f7810-e539-45aa-b122-55991f7391fd.png" width="304.56" style="max-width:1001px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                    </a>
                                            ...
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <div style="text-align: center;"><strong><span style="font-size:18px">Welcome!</span></strong><br>
                                                        <span style="font-size:14px">Your application&nbsp;has now been reviewed and approved. Start earning crypto&nbsp;today by uploading a video via your publisher panel.<br>
<br>
...
For this service, just click the "Request Import" button below. You can create a request later via our message center inside your publisher panel if you do not want to do this now.</span></div>
                                ...
                                <tr>
                                    <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 6px;background-color: #F15858;">
                                            <tbody>
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 18px;">
                                                    <a class="mcnButton " title="Request Import" href="" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Request Import</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 6px;background-color: #444444;">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 15px;">
                                                    <a class="mcnButton " title="Visit your Publisher Panel" href="" target="_blank" style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit your Publisher Panel</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
