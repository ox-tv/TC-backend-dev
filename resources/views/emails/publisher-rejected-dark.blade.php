                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <div style="text-align: center;"><span style="color:#FFFFFF"><strong><span style="font-size:18px">Your publisher request has been rejected.</span></strong></span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="color:#FFFFFF">The reason why your application is rejected may be due to the following:</span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="color:#FFFFFF">1.&nbsp;We could not verify you or your channel.<br>
