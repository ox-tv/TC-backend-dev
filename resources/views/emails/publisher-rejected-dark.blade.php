...
<head>
    ...
    <title>Publisher Request Rejected</title>
                                        ...
                                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                            <tbody><tr>
                                                <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                    ...
                                                    <a href="https://www.todayscrypto.com" title="" class="" target="_blank"><img align="center" alt="" src="{{ asset('assets/images/TC-Email-logo-light.png') }}" style="width:170px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                    </a>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <div style="text-align: center;"><span style="color:#202020"><strong><span style="font-size:18px">Your publisher request has been rejected.</span></strong></span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="color:#202020">The reason why your application is rejected may be due to the following:</span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="color:#202020">1.&nbsp;We could not verify you or your channel.<br>
2.&nbsp;A channel with the selected name already exists.<br>
3.&nbsp;Channel content violates our policy.</span></div>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 6px;background-color: #F15858;">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica Neue, Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 12px;">
                                                    <a class="mcnButton " title="Contact Support" href="{{ $supportLink }}" target="_blank"style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF; text-transform: uppercase;">Contact Support</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
