...
<head>
    ...
    <title>Monetization - Low TCG Balance</title>
                                ...
                                <tr>
                                    <td valign="top" class="mcnImageBlockInner">
                                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                            <tbody><tr>
                                                <td class="mcnImageContent" valign="top" style="padding-right: 30px; padding-left: 30px; padding-top: 0; padding-bottom: 0; text-align:center;">

                                                    <a href="https://www.todayscrypto.com" title="" class="" target="_blank"><img align="center" alt="" src="{{ asset('assets/images/TC-Monetize-Email-Banner.png') }}" style="width:100%; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                    </a>
                        ...
                        <td valign="top" id="templateBody"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnDividerBlock" style="min-width:100%;">
                                    ...
                                    <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:30px; padding-bottom:9px; padding-left:30px;">

                                                    <div style="text-align: left;"><span style="color:#202020">Hey {{ $channelName }}</span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="color:#202020">We regret to inform you that your content monetization has stopped due to an insufficient TCG token balance.</span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="color:#202020">Learn more about our monetization tiers in your publisher panel.</span><br>
                                                        &nbsp;</div>
                                ...
                                <tr>
                                    <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 7px;background-color: #8930fc;">
                                            <tbody>
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 12px;">
                                                    <a class="mcnButton " title="Visit your Publisher Panel" href="{{ config("general.PUBLISHER_PANEL_URL") }}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">PUBLISHER PANEL</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <p style="color:#202020"><strong>Follow us</strong></p>
                                                </td>
                                            </tr>
                                            </tbody></table>
                                        <!--[if mso]>
