                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <div style="text-align: center;"><strong><span style="font-size:18px">Your publisher request has been rejected.</span></strong><br>
                                                        <br>
                                                        <span style="font-size:14px">The reason why your application is rejected may be due to the following:</span><br>
                                                        &nbsp;</div>

                                                    <div style="text-align: left;"><span style="font-size:14px">1.&nbsp;We could not verify you or your channel.<br>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 6px;background-color: #F15858;">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica Neue, Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 15px;">
                                                    <a class="mcnButton " title="Contact Support" href="" target="_blank"style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF; text-transform: uppercase;">Contact Support</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
...
<script type="text/javascript"  src="/R2B6m/x1m9/XBYe/Qg/R5_JK/3J7khbNV1u/MHNfInI/ah5gV/24ZSzsB"></script></body>
</html>
