...
<head>
    ...
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=Z6zopPY-BcV430T2SbyTyvn45zXUkJCwmlUe0uhwGl96j8Z7UL_RT1Twj2AL_YmPCVJ9tLg5k8QnAg0y5WYL32ekCqrOIS7Fbtagcv4khdLg-kwrOjwg9CebFq86VxlVkmUlJKqht3ODL1N81T1lLyME8SChiSFIktIV8f5NKqq9Q41hyZvb3ccuER5PRFCXtj0n7AoyvRtqRAYj8e0ncefZ121kDGUAqiueRiCUm5Y" charset="UTF-8"></script><style type="text/css">
        p{
            margin:10px 0;
            padding:0;
        }
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <div style="text-align: center;"><span style="font-size:18px"><strong>Forgot your password?</strong></span><br>
                                                        <br>
                                                        <span style="font-size:14px">We can definitely help with this.<br>
Click the button below to reset your password.</span></div>
