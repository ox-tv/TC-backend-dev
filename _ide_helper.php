 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function emailVerification($user, $scope)
        {
                        /** @var \App\Services\TCAuthManager $instance */
                        return $instance->emailVerification($user, $scope);
        }
                    /**
         ...
         * @param string $driver
         * @param callable $callback
         * @return \App\Services\TCAuthManager 
         * @static 
         */ 
...
namespace  { 
            ...
            class TCNotification extends \App\TCNotification\TCNotification2Facade {}
