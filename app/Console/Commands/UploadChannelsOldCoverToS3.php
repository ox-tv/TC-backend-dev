...
class UploadChannelsOldCoverToS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'upload:channels-old-cover-to-s3';
     ...
     * @var string
     */
    protected $description = 'Upload channels old cover to s3 and put in database';
    ...
    {
        $channels = Channel::withTrashed()->whereNotNull('cover')->get();
        ...
        foreach ($channels as $channel){
            try{
                $file = Storage::disk('public')->path($channel->cover);
